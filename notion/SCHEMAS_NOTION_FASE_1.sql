...
CREATE TABLE "Gestao de Tarefas" (
  ...
  "Prazo" DATE,
  "Status" STATUS('Backlog':gray, 'A fazer':blue, 'Em andamento':yellow, 'Aguardando terceiro':orange, 'Aguardando aprovacao':purple, 'Concluida':green, 'Cancelada':red),
...
CREATE TABLE "Banco de Terrenos" (
  ...
  "Contato" RICH_TEXT,
  "Status do terreno" STATUS('Novo terreno':blue, 'Dados pendentes':yellow, 'Em triagem':purple, 'Analise de localizacao':orange, 'Analise juridica/documental':red, 'Estudo de vocacao':purple, 'Viabilidade preliminar':yellow, 'Em negociacao':orange, 'Aprovado para projeto':green, 'Reprovado':red, 'Banco futuro':gray),
...
CREATE TABLE "Propostas Comerciais" (
  ...
  "Responsavel" RICH_TEXT,
  "Status" STATUS('Solicitada':blue, 'Briefing pendente':yellow, 'Em elaboracao':purple, 'Em revisao interna':orange, 'Aguardando aprovacao':red, 'Aprovada para envio':green, 'Enviada':blue, 'Em negociacao':yellow, 'Aceita':green, 'Recusada':red, 'Arquivada':gray),
  "Prazo" DATE,
  "Escopo" RICH_TEXT,
...
CREATE TABLE "Relatorios Executivos" (
  ...
  "Periodo" DATE,
  "Responsavel" RICH_TEXT,
  "Status" STATUS('Rascunho':gray, 'Em revisao':yellow, 'Aprovado':green, 'Enviado':blue, 'Arquivado':red),
